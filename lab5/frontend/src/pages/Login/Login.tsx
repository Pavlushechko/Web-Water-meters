...
export function Login() {
    ...
    const { error, handleSubmit, goToRegister, handleGoBack, goToServices } = LoginHook(); // Используем хук
    ...
    return (
        <div className={styles.login_container}>
            ...
            <form onSubmit={onSubmit}>
                ...
                <button className={styles.button} onClick={goToServices} type="submit">Войти</button>
            </form>
